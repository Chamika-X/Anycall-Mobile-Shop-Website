...
function pdfdonw() {
  document.getElementById("download").addEventListener("click", () => {
    ...
    var opt = {
      margin: 0.5,
      filename: "AnyCall MobileLK_invoice.pdf",
    ...
    if (r.readyState == 4) {
      ...
      if (text == "1") {
        ...
        var payment = {
          sandbox: true,
          merchant_id: "1219168", // Replace your Merchant ID
          return_url: "http://localhost/AnyCall Mobile/cart.php", // Important
          cancel_url: "http://localhost/AnyCall Mobile/cart.php", // Important
          notify_url: "http://sample.com/notify",
          order_id: obj["id"],
          items: obj["item"],
          amount: obj["amount"] + ".00",
