...
<head>
    ...
    <title>AnyCall Mobile | Admin Signin</title>
        ...
        <div class="row align-content-center">
            ...
            <div class="col-12">
                <div class="row">
                    ...
                    <div class="col-12">
                        <h2 class="text-center fw-bold">Hi, Welcome to AnyCall Mobile Admins</h2>
                    </div>
                </div>
            </div>
            <!--heder-->
            ...
            <div class="col-12 d-none d-md-block fixed-bottom">
                <p class="text-center">&copy; 2021 AnyCall Mobile.lk All Rights Reserved</p>
            </div>
            <!--footer-->
