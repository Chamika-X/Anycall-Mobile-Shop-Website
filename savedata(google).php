...
$brs = $bc->num_rows;
    ...
    $mail->SMTPAuth = true; 
    $mail->Username = 'wikum.dev@gmail.com'; 
    $mail->Password = 'hsyhjxcjhlvuhmth';
    $mail->SMTPSecure = 'ssl';
    $mail->Port = 465;
    $mail->setFrom('wikum.dev@gmail.com', 'AnyCall Mobile'); 
    $mail->addReplyTo('wikum.dev@gmail.com', 'AnyCall Mobile'); 
    $mail->addAddress($email); 
    $mail->isHTML(true); 
    $mail->Subject = 'AnyCall Mobile Temporary Password'; 
          ...
          <table cellspacing="0" cellpadding="0" width="100%">
            ...
            <tr>
              <td class="hide-for-mobile"  height="150" valign="top" >
                <b>
                  <span>AnyCall Mobile.LK</span>
                  </b>
                <br>
                <span>No 80, AnyCall Mobile, Kandy</span>
              </td>
            </tr>
                        ...
                        <tr>
                          <td>
                            <table cellspacing="0" cellpadding="0" width="100%">
                              ...
                              <tr>
                                <td class="progress-text progress-text-padded">Goto AnyCall Mobile</td>
                      ...
                      <table cellspacing="0" cellpadding="10" width="100%">
                        <tr>
                          <td>
                            ...
                            Your account has successfully Created! Click below to Signin to your AnyCall Mobile account! Here is your temporary Password: '.$password.'
                          </td>
                        </tr>
                      </table>
                          ...
                          <td width="150" style="width:150px;">
                            <div style="text-align:center; background-color:#48be19;"><!--[if mso]>
                                  <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="#" style="height:35px;v-text-anchor:middle;width:150px;" arcsize="8%" stroke="f" fillcolor="#48be19">
                                    <w:anchorlock/>
                                    <a href="http://localhost/AnyCall Mobile/index.php"><center style="color:#ffffff;font-family:sans-serif;font-size:16px;">Goto AnyCall Mobile</center></a>
                                  </v:roundrect>
                                <![endif]-->
