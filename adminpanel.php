...
?>
  ...
  <head>
    ...
    <title>AnyCall Mobile | AdminPanel</title>
  ...
  <body>
          ...
          <div class="navbar-header">
            <!-- Navbar Header--><a href="adminpanel.php" class="navbar-brand">
              <div class="brand-text brand-big visible text-uppercase">
                <strong class="text-primary">AnyCall</strong><strong>Mobile</strong>
              </div>
              <div class="brand-text brand-sm">
                <strong class="text-primary">A</strong><strong>M</strong>
              </div>
            </a>
            <!-- Sidebar Toggle Btn-->
    ...
    <div class="d-flex align-items-stretch">
      ...
      <div class="page-content">
        ...
        $startdate = new DateTime("2024-10-07 00:00:00");
                ...
                <div class="stats-2-block block d-flex">
                  <div class="stats-2 d-flex">
                    ...
                    <div class="stats-2-content">
                      <h3 class="d-block">Total Active Days</h3>
    ...
    <!-- JavaScript files-->
    <script>
      const finaleDate = new Date("October 07, 2024 00:00:00").getTime();
