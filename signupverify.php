    ...
    if (isset($email)) {
        ...
        if (empty($email)) {
            ...
            if ($rs->num_rows == 0) {
                ...
                $mail->addAddress($e);
                $mail->isHTML(true);
                $mail->Subject = 'AnyCall Mobile email verification Code';
                $bodyContent = '<h1 style="color:red;">Your Verification Code: ' . $code . '</h1>';
                $bodyContent .= '<p>AnyCall Mobile Email Verify Process. Please use this code to reset your password. Thank you for use our service.</p>';
